...
public class MessageConstant {
    ...
    public static final String QUERY_MENU_SUCCESS = "查询菜单列表数据成功";
    public static final String QUERY_MENU_FAIL = "查询菜单列表数据失败";
    public static final String QUERY_MENU_EMPTY = "查询菜单数据为空";
    public static final String ADD_MENU_SUCCESS = "新增菜单列表数据成功";
    public static final String ADD_MENU_FAIL = "新增菜单列表数据失败";
    public static final String EDIT_MENU_SUCCESS = "编辑菜单列表数据成功";
    public static final String EDIT_MENU_FAIL = "编辑菜单列表数据失败";
    public static final String DELETE_MENU_SUCCESS = "删除菜单列表数据成功";
    public static final String DELETE_MENU_FAIL = "请先删除子菜单";
